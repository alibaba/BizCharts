...
import { Chart, Geom, Axis, Shape, Util, PathUtil, Label } from '@ali/bizcharts';
...
ReactDOM.render((
  <div>
    <Chart height={300} data={data} forceFit padding={[50, 100, 50, 60]}>
      <Axis
        name="genre"
        tickLine={null}
        line={null}
      ...
      <Geom
        ...
        label={['sold', {
          ...
          renderer: (val) => {
            ...
            return '<div style="color:#999;font-size:10px;position:relative;left:15px;top:' + topOffset + 'px">' +
                    val +
                    '%</div>';
          }
        }]}
