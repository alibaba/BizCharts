...
![预览](http://bizcharts-resource.oss-cn-zhangjiakou.aliyuncs.com/images/77d56df0-9979-11ea-a591-9be663db1ad5.png)
...
let data;
$.ajax({
  url: "https://alifd.alibabausercontent.com/materials/@bizcharts/relation-radial-dendrogram/0.3.0/mock.json",
  async : false,
...
ReactDOM.render(<Radialdendrogram />, mountNode)
