...
![预览](http://bizcharts-resource.oss-cn-zhangjiakou.aliyuncs.com/images/77b40340-9979-11ea-a591-9be663db1ad5.png)
...
let data;
$.ajax({
  url: "https://alifd.alibabausercontent.com/materials/@bizcharts/g2-brush-highlight/0.2.9/mock.json",
  async : false,
...
ReactDOM.render(<Brushhighlight />, mountNode)
