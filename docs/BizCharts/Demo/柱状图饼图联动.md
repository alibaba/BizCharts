...
![预览](http://bizcharts-resource.oss-cn-zhangjiakou.aliyuncs.com/images/77e52560-9979-11ea-a591-9be663db1ad5.png)
...
let data;
$.ajax({
  url: "https://alifd.alibabausercontent.com/materials/@bizcharts/other-bar-change-pie/0.3.1/mock.json",
  async : false,
...
ReactDOM.render(<Barchangepie />, mountNode)
