# 使用filter实现默认隐藏某图例下的数据

![预览](http://bizcharts-resource.oss-cn-zhangjiakou.aliyuncs.com/images/2c6e9380-ecc8-11ea-9acb-c57e520f8c17.png)
...
function Demo() {
    return <Chart scale={{ temperature: { min: 0 } }} padding={[10, 20, 50, 40]} autoFit height={500} data={data} >
