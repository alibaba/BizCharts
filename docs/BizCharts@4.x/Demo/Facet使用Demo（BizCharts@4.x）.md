# Facet使用Demo（BizCharts@4.x）

![预览](http://bizcharts-resource.oss-cn-zhangjiakou.aliyuncs.com/images/105a3120-1380-11eb-8f13-61bc40b8cb5c.png)
...
function Demo() {
  return <Chart autoFit data={data} height={400} padding={[20, 20, 20, 70]} >
