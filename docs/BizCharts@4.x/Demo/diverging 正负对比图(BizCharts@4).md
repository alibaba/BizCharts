# diverging 正负对比图(BizCharts@4)

![预览](http://bizcharts-resource.oss-cn-zhangjiakou.aliyuncs.com/images/b46c2010-677d-11eb-9b2e-1bd85a98cb49.png)
...
ReactDOM.render(<Bardiverge />, mountNode)
```
